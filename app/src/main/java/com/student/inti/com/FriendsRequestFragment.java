...
public class FriendsRequestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRequestsDatabase = FirebaseDatabase.getInstance().getReference().child("Friend_Requests").child(mCurrent_user_id);
    ...
    public static  class RequestsViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setUserImage(String thumb_image, Context ctx){
            ...
            Picasso.get().load(thumb_image).placeholder(R.mipmap.download).into(userImageView);
